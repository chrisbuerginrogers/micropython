...
def main():
    ...
    if accel_ok:
        try:
            accel.enable_wake_int1(threshold=8)  # pyright: ignore[reportOptionalMemberAccess]  # non-None when accel_ok
        ...
        try:
            ...
            if nfc_sleeping:
                ...
                if btn.value() == 0:
                    ...
                    try:
                        x, y, z = accel.read()  # pyright: ignore[reportOptionalMemberAccess]  # non-None when accel_ok
